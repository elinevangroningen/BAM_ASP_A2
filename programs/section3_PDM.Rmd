...
# Merge averages in dfWorld.avg with dfWorld.sub (this can be done
# with 'mutate', but then the concise data frame with country
...
#both RE and FE are consistent (though FE is not efficient), under H1, correlation between disturbance, only FE consistent
